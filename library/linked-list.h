...
// found in the LICENSE file: https://github.com/mirror/chromium/blob/trunk/LICENSE

#ifndef THIRD_PARTY_BASE_CONTAINERS_LINKED_LIST_H_
#define THIRD_PARTY_BASE_CONTAINERS_LINKED_LIST_H_
...
#endif  // THIRD_PARTY_BASE_CONTAINERS_LINKED_LIST_H_